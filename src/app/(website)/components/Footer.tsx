    ...
    <footer className="bg-white dark:bg-surface-900">
      {/* <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 md:grid-cols-4 lg:py-8">
          <div>
            <h2 className="mb-6 text-sm font-semibold uppercase text-surface-900 dark:text-white">
              Company
            </h2>
            <ul className="font-medium text-surface-500 dark:text-surface-400">
              <li className="mb-4">
      ...
      <div className={"flex flex-col gap-2 p-3 text-center"}>
        <a
          className={
            "font-headers text-sm font-medium uppercase text-text-disabled"
          }
          href={"https://firecms.co"}
        >
          Built with <b>FireCMS</b>{" "}
        </a>
      </div> */}
    </footer>
  );
